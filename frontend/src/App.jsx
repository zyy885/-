...
function BottomTabBar() {
  ...
  const studentTabs = [
    ...
    },
    {
      ...
      label: '练习',
      icon: '✏️',
      single: { to: '/student/self-test-select', label: '单词自测' },
      match: ['/student/self-test', '/student/self-test-select'],
    },
    {
      key: 'discover',
      label: '发现',
      ...
      match: ['/student/sentence-practice', '/student/wrong-book', '/student/favorites', '/student/stats', '/student/leaderboard', '/student/comments'],
    },
    {
      key: 'mine',
      label: '我的',
